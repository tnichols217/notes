...
> BCC: $68\%$
> 
> 2 atoms per cube, radius of $\frac{a\sqrt{3}}{2}$
> $V=2\cdot\frac{4}{3}\pi{\frac{a\sqrt{3}}{4}}^3$
> $V=0.6802a^3$
> $=68\%$
> 
> FCC: $74\%$
> 
> 4 atoms per cube, radius of $\frac{a}{\sqrt{2}}$
> $V=4\cdot\frac{4}{3}\pi\frac{a}{2\sqrt{2}}^3$
> $V=0.7404a^3$
> $=74\%$
