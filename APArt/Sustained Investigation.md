...
Initially I wanted to create pieces that showed the chaos of the instruments representing strong feelings of overwhelm and fear, but after much experimentation, I found that cohesivity is much more important for telling a story through my art. Finding the proper balance between distortion, expression, and emotion and familiarity, relatability, and visual cohesivity took much practice over the span of my investigation. For example, the initial idea for DAMAGED RECOLLECTIONS was to have the french horn be a tangled metal pipe, much like tangle