...
### 2.2.1 Calculation of velocity and position
...
1. After collecting all the data, we first derived the velocity and position through the formulae derived in section [[PHYS 121 - Physics 1/Labs/5/5#2.2.1 Calculation of velocity and position|2.2.1]].
...
4. From that, we obtained our estimated Inertia of the weights through the formulae given in section [[PHYS 121 - Physics 1/Labs/5/5#2.2.4 Difference in Inertia for experimental setup|2.2.4]] and [[PHYS 121 - Physics 1/Labs/5/5#2.2.3 Measurement of Inertia|2.2.3]] for the experimental and Monte-Car
5. We also calculate the variance in the Inertia value
