...
&\delta_{I_L}=\sqrt{\left(4gM_hr\left(\frac{1}{\frac{v_{W+L}^2}{y_{W+L}}}-\frac{1}{\frac{v_{W}^2}{y_{W}}}\right)\right)^2+\delta_{\frac{v_{W+L}^2}{y_{W_L}}}^2+\delta_{\frac{v_W^2}{y_W}}^2}
\end{align*}
$$
