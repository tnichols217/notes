...
&\delta_{I_L}=\sqrt{\left(4gM_hr\left(b_{W+L}^{-1}-b_{W}^{-1}\right)\right)^2+\left(\delta_{\frac{v_{W+L}^2}{y_{W_L}}}2gM_hr^2\left(\frac{1}{\frac{v_{W+L}^2}{y_{W+L}}}\right)^2\right)^2+\left(\delta_{\frac{v_W^2}{y_W}}2gM_hr^2\left(\frac{1}{\frac{v_W^2}{y_W}}\right)^2\right)^2}
\end{align*}
$$
