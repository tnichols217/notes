...
After collecting all the data, we first derived the velocity and position through the formulas derived in section [[PHYS 121 - Physics 1/Labs/5/5#2.2.1 Calculation of velocity and position|2.2.1]].
