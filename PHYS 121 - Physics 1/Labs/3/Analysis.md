...
$\delta_\epsilon=\sqrt{\delta_{\epsilon U_{kf}}^2+\delta_{\epsilon U_{gf}}^2}=\sqrt{\left( \frac{\delta_{U_{kf}}}{|U_{gf}|}\right)^2+\left( \delta_{U_{gf}}\left( -\frac{U_{kf}}{U_{gf}^2} \right) \right)^2}$
