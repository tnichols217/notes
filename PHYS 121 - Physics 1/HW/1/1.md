...
> $\begin{cases}v(0)=v_0\\v\left( \frac{t_f}{2} \right)=v_0+\frac{At_f}{2}\\v(t_f)=v_0\end{cases}$
> 
> If $A$ is positive, we can conclude that the greatest velocity is at $t=\frac{t_f}{2}$, else we can conclude the grea
