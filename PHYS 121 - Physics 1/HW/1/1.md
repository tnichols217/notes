...
> [!answer]
> The weight force of the block is always pointed straight "down", and since in this case the block doesn't move down — or parallel to the force. The dot product of the movement and force is always $0$, wh