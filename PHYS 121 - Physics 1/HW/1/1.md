...
> $x(t)=x_0+\begin{cases}v_0t+ \frac{1}{2}At^2&0\le t< \frac{t_f}{2}\\ \frac{1}{8}At_f^2+v_0t+A\left( \left( t_ft- \frac{t_f^2}{2} \right)-\frac{1}{2}\left( t- \frac{t_f}{2} \right)^2\right)& \frac{t_f}{2}\le t\le t_f\end{cases}$
