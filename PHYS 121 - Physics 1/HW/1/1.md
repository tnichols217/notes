...
> $x(t)=x_0+\int\limits_0^t\begin{cases}v_0t+ \frac{1}{2}At^2&0\le t< \frac{t_f}{2}\\ v_0\left( t- \frac{t_f}{2} \right)+A\left( t_f\left( t- \frac{t_f}{2} \right)-\frac{1}{2}\left( t- \frac{t_f}{2} \right)^2\right)& \frac{t_f}{2}\le t\le t_f\end{cases}~dt$
