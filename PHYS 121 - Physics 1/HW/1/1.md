...
Assuming that the block starts at rest, what is the final speed block when it has traveled a distance D?

> [!answer]
> Since we know the floor is horizontal and the block does not gain any potential energy, we can assume in this case that all added energy 