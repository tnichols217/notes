...
> ![[image71-g.png]]
> 
> The position at time $t$ is equal to the original position $x_0=0$ at $t=0$ plus the integral over the time interval of velocity. Taking the integral of the velocity over the entire time frame could be estimated by taking the area under the curve of velocity over the time, which is approximately $107$blocks, at $1 \frac{m}{s}\times0.2s=0.2m$ per block, this gives us the estimated integral at $21.4m$. Adding the initial position of 