...
> 
> If $A$ is positive, we can conclude that the greatest velocity is at $t=\frac{t_f}{2},v=v_0+\frac{At_f}{2}$, else we can conclude the greatest velocity is at the beginning and the end at $v=$.
