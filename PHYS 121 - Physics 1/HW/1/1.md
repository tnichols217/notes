...
> ![[image71-f.png]]
> 
> We can estimate the acceleration by taking the slope of the tangent line to the velocity vs. time graph at $t=1.0s$. I drew a tangent line at $t=1.0s$ on the graph ans 
