...
> $\vec N_{AB}=\langle0,gm_A\rangle$
> 
> $\vec N_{AB}=-\vec N_{BA}$ Newton's second
> $\vec N_{BA}=\langle0,-gm_A\rangle$
> $\vec W_B=\langle0,-gm_B\rangle$
> $\vec N_{BT}=\langle0,g(m_A+m_B)\rangle$
> 
> $\vec N_{TB}=-\vec N_{BT}$ Newton's second
> $\vec N_{TB}=\langle0,-g(m_A+m_B)\rangle$
> $\vec W_T=\langle0,-gm_T\rangle$
> $\vec N_{TF}=\langle0,g(m_A+m_B+m_T)\rangle$
> 
> ---
> 
