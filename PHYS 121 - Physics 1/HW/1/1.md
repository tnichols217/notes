...
> $x(t)=x_0+\begin{cases}v_0t+ \frac{1}{2}At^2&0\le t< \frac{t_f}{2}\\ \frac{1}{8}At_f^2+v_0t+A\left( t_ft- \frac{t_f^2}{2}-\frac{1}{2}t^2+\frac{1}{2}tt_f- \frac{1}{8}t_f^2\right)& \frac{t_f}{2}\le t\le t_f\end{cases}$
