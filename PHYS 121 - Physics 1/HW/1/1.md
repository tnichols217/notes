...
> $D=x(t_f)=x_0+\int\limits_0^tv_0+\int\limits_0^ta(t)~dt~dt\bigg|_{t=t_f}$
> $D=x_0+\int\limits_0^tv_0+\int\limits_0^{ \frac{t_f}{2}}a(t)~dt+\int\limits_{\frac{t_f}{2}}^{t_f}a(t)~dt~dt\bigg|_{t=t_f}$
> $D=x_0+\int\limits_0^{t_f}v_0+\int\limits_0^{ \frac{t_f}{2}}A~dt+\int\limits_{\frac{t_f}{2}}^{t_f}-A~dt~dt\bigg|_{t=t_f}$
