...
An apple sits at rest on top of a book which in turn sits on a table that sits on the floor. The mass of the apple is given as $m_A = 76~g$ and the mass of the book is $m_B = 1.07 ~kg$ and the mass of the table is mT = 13.4 kg.
