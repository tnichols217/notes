...
> [!answer]
> No, this equation assumes we have constant acceleration across the entire time interval (hence $a$ not being a function of $t$). As we have established in part (b), 
