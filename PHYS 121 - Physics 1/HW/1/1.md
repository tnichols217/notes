...
> [!answer]
> $a(t)=\begin{cases}A&0\le t< \frac{t_f}{2}\\-A& \frac{t_f}{2}\le t\le t_f\end{cases}$
> $x(t)=x_0+\int\limits_0^tv_0+\int\limits_0^ta(t)~dt~dt$
> $x(t)=x_0+\int\limits_0^tv_0+\begin{cases}At&0\le t< \frac{t_f}{2}\\ \frac{t_f}{2}A-A\left( t- \frac{t_f}{2} \right)& \frac{t_f}{2}\le t\le t_f\end{cases}~dt$
> $x(t)=x_0+\int\limits_0^t\begin{cases}v_0+At&0\le t< \frac{t_f}{2}\\ v_0+A\left( t_f-t\right)& \frac{t_f}{2}\le t\le t_f\end{cases}~dt$
> $x(t)=x_0+\begin{cases}v_0t+ \frac{1}{2}At^2&0\le t< \frac{t_f}{2}\\ \frac{v_0t_f}{2}+\frac{1}{8}At_f^2+v_0\left( t- \frac{t_f}{2} \right)+A\left( t_f\left( t- \frac{t_f}{2} \right)-\frac{1}{2}\left( t- \frac{t_f}{2} \right)^2\right)& \frac{t_f}{2}\le t\le t_f\end{cases}$
> $x(t)=x_0+\begin{cases}v_0t+ \frac{1}{2}At^2&0\le t< \frac{t_f}{2}\\ \frac{1}{8}At_f^2+v_0t+A\left( \left( t_ft- \frac{t_f^2}{2} \right)-\frac{1}{2}t^2+\frac{1}{2}tt_f- \frac{1}{2}\frac{t_f^2}{4}\right)& \frac{t_f}{2}\le t\le t_f\end{cases}$
