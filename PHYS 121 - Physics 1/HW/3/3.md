...
> [!answer]
> Nothing is conserved as the floor is not in the system, so it will have an external force on the system. The medicine ball also loses KE as it slows down after the collision,
