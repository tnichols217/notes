...
![[PHYS 121 - Physics 1/HW/3/images/5a.svg]]
...
> 
> Since $\alpha$ is constant, and $\omega_f=0$, the integral of $\omega(t)$ from start until stop will take the form of $\frac{1}{2}\omega_0\frac{\omega_o}{-\alpha}$ (area of a triangle).
> 
> $\theta=\frac{\omega_0^2CMR^2}{4F_{app} r\sin\phi}$
> $\text{Rot}=\frac{\omega_0^2CMR^2}{8\pi F_{app} r\sin\phi}$
...
> ![[6a.svg]]
> 
> Since nothing is accelerating, we know that all net forces and net torques are 0.
> 
> $N_{CB}=W_C=mg$ 2nd law
> $N_{BC}=N_{CB}=mg$ 2nd law
> $W_B=Mg$
> $(M+m)g=N_{BT}+T_1$ 2nd law
> 
> Choosing the pivot as the trestle,
> $\tau_T=Fr=0F=0$
> $\tau_{T_1}=\frac{3L}{4}T_1\sin \frac{-\pi}{2}=-\frac{3LT_1}{4}$
> $\tau_W=\frac{L}{4}W_B\sin \frac{\pi}{2}=\frac{LMg}{4}$
> $\tau_N=Fr=0F=0$
> 
> $0=\tau_{net}=\frac{LMg}{4}-\frac{3LT_1}{4}$
> $LMg=3LT_1$
> $T_1=\frac{Mg}{3}$
> 
> $(M+m)g=N_{BT}+\frac{LMg}{3L}$
> $N_{BT}=(M+m)g-\frac{Mg}{3}$
> 
> ---
> 
> $T_1=\frac{Mg}{3}$
