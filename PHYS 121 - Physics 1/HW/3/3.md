...
What is the Total Work done by all forces on the car as it moves on the curve from point P (corresponding to where the car enters the curve) to the point Q (corresponding to where the car leaves the curve)? Explain how you know this? Important: you must use one or more
Physics Concept(s) here