...
> [!answer]
> $\omega(t)=\omega_0-\frac{2F_{app} rt\sin\phi}{CMR^2}$
> 
...
> $P=\omega_0t-\frac{F_{app} rt^2\sin\phi}{2\pi CMR^2}$ Convert from radians to rotations
> 
> ---
> 
> $\omega_0t-\frac{F_{app} rt^2\sin\phi}{2\pi CMR^2}$
> $\square$
