...
> [!answer]
> Wrong. If we had a force to the right then we would go to the right??? Since we move towards the left (from the perspective of the driver) then we should have a correst
