...
Suppose the coefficients of kinetic friction and static friction are given as $\mu_k$ and μs respectively. What is the constraint that applies to the value of θ that ensures that the
ladder stays at rest and does not slip and fall down? Explain your work.