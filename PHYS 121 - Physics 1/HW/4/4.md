...
> $\vec r=\langle -P\Omega\sin(\Omega t)-Q\omega\sin(\omega t),P\Omega\cos(\Omega t)+Q\omega\cos(\omega t)\rangle$
> 
...
> $\begin{cases}\Omega t\in\left\{ \frac{\pi}{2}, \frac{3\pi}{2} \right\}\\ \omega t\in\left\{ \frac{\pi}{2}, \frac{3\pi}{2} \right\}\\ P\sin(\Omega t)+Q\sin(\omega t)>0\end{cases}$
> 
> 
