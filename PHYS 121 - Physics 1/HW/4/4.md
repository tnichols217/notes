...
> $s=\|\vec v\|$
> 
> $\vec v=\left\langle  -8\pi\sin\left( \frac{\pi}{2} \right)-30\pi\sin\left(\frac{15t}{2} \right),8\pi\cos\left( \frac{\pi}{2} \right)+30\pi\cos\left( \frac{15t}{2} \right) \right\rangle$
> $s=\sqrt{(-8\pi\sin\left( \frac{\pi}{2} \right)-30\pi\sin\left(\frac{15t}{2} \right))^2+(8\pi\cos\left( \frac{\pi}{2} \right)+30\pi\cos\left( \frac{15t}{2} \right))^2}$
> 
