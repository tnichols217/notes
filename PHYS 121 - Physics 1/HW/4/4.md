...
> $\vec v_f=v_0\langle0,\sin\theta\rangle$
> 
> $v_0^2+gh=(v_0\sin\theta)^2+gh_f$
> $h_f=\frac{v_0^2-(v_0\sin\theta)^2}{g}+h$
> $h_f=\frac{v_0^2(1-\sin^2\theta)}{g}+h$
> $h_f=\frac{(v_0\cos\theta)^2}{g}+h$
> 
> ---
> 
> $h_f=\frac{(v_0\cos\theta)^2}{g}+h$
...
> [!answer]
> Since the only force acting upon the tennis ball is the force of gravi
