...
> 
> $y(t_{max})=y_0+\frac{gTt_{max}}{2}-\frac{gt_{max}^2}{2}$
> $y(t_{max})=y_0+\frac{gT^2}{4}-\frac{gT^2}{8}$
...
> 
> $\vec p(t)=\langle0,y_0+\frac{gTt}{2}-\frac{gt^2}{2}\rangle$
