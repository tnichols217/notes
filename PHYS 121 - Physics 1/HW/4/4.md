...
At what speed $v_0$ and at what angle θ relative to the horizontal should you throw the ball so that the ball just barely clears the top of the tower at its maximum height, as shown? Give your answers in terms of given parameters only. Explain your work.
