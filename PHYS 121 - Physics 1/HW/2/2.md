...
A motorcyclist performs a somewhat nauseating trick by driving on a vertical circular track
(so-called “loop-the-loop”). The position of the motorcyclist is show at four positions (A, B, C,
D) corresponding to bottom, right, top and left points on the track respectively. The mass of the
motorcyclist and his motorcycle together is given as m. The radius of the circular path is given as
R.
