...
## b
 ...
 Calculate **all** of the forces on each of the two blocks. Also calculate the accelerations, $a_A$ and $a_B$ for each of the two blocks. Express your answers in terms of the given parameters. Show
your work.
