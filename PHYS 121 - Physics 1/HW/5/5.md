...
> [!answer]
> Since the motion of the block is sinusoidal as it is a reciprocating spring, velocity is also represented by a sinusoidal function.
> 
> Since the motion is sinusoidal, we know the 
