...
> $y_{avg}=-\frac{mg}{k}$
> 
> We can now use conservation of energy to find the amount of kinetic energy at this point.
> 
> Using the same starting point as part (b) with no initial energy
> 
> $$
