...
> [!answer]
> If we treat everything except the rope as a system, it is only being accelerated upwards due to the two tension forces, which must be equal.
> 
> $F_{net}=A_0(m_p+m_l+m_)$
