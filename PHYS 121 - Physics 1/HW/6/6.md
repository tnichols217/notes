...
> $\begin{cases}v_0=3v_{abf}+5v_{cf}\\ v_0^2= 6v_{abf}^2+ 10v_{cf}^2\end{cases}$
> $\begin{cases} \frac{v_0-3v_{abf}}{5}=v_{cf}\\ v_0^2= 6v_{abf}^2+ 2(\frac{v_0^2-6v_0v_{abf}+9v_{abf}^2}{5})\end{cases}$
> $\begin{cases} \frac{v_0-3v_{abf}}{5}=v_{cf}\\ v_0^2= \frac{48}{5}v_{abf}^2- \frac{12}{5}v_0v_{abf}+ \frac{2}{5}v_0^2\left( \frac{v_0^2}{5} \right)\end{cases}$
