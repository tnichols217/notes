...
Amy stands on the floor and pulls hard on a rope that is attached to a massive pulley and a block as shown above. The mass of the block is given as $M$ . The mass of the pulley has the same given mass M . Amy’s mass is given as 3M . Amy pulls so that the block accelerates upward with
a given constant acceleration ~a0 . Assume that the pulley wheel can be represented as a solid disk
with rotational inertia given by I = 12 mR2 .
What are all of the forces on Amy? Determine the type, magnitude, and direction of
each force. Explain your work. If you are using Newton’s Laws here, be sure to include clearly
labeled Free-Body-Diagrams and/or Extended-Free-Body-Diagrams as needed. Your work for this
problem needs to be complete, neat, coherent, and completely explained to earn full credit.