...
Use De Morgan’s laws to write negations for the statement "This computer program has a logical error in the first ten lines or it is being run with an incomplete data set."
