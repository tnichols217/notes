...
> [!answer]
> Let $A$ be the set of computer programs, $E(x)$ be the proposition "X contains an error":
> $$\begin{align*}(\forall a\in A : E(a)) \to (a\in A \to E(a)) & & (1)  \\ \exists a\in A : \lnot E(a) & & (2) \\ \lnot(\forall a \in A : E(a)) & & (3) \end{align*}$$
> 
