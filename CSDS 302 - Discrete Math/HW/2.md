...
If statement forms $P$ and $Q$ are logically equivalent, then $P\leftrightarrow Q$ is a tautology. Conversely, if $P\leftrightarrow Q$ is a tautology, then $P$ and $Q$ are logically equivalent. Use $\iff$ to convert the logical equivalence to a tautology. Then use a truth table to verify each tautology.
