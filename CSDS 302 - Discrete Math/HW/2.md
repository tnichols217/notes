...
If statement forms $P$ and $Q$ are logically equivalent, then $P\iff Q$ is a tautology. Conversely, if $P\iff Q$ is a tautology, then $P$ and $Q$ are logically equivalent. Use $\iff$ to convert each of the logical equivalences in 29–31 to a tautology.
