...
As you can see in the table, I have italicized or bolded the rows where all the premises are true. The first and third line both have true conditions, but the middle one is false, which means that given the nec
