...
Two new drugs are to be tested using a group of $60$ laboratory mice, each tagged with a number for identification purposes. Drug $A$ is to be given to $22$ mice, drug $B$ is to be given to another $22$
mice, and the remaining $16$ mice are to be used
as controls. How many ways can the assignment
of treatments to mice be made? (A single assign-
ment involves specifying the treatment for each
