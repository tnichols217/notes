...
Let $G$ be the graph with vertices $v_1,v_2,v_3$
and with $A$ as its adjacency matrix. Use the
answers to part (a) to find the number of walks
of length 2 from $v1$ to v3 $and$ the number of
walks of length 3 from v1 to v 3. Do not draw G
