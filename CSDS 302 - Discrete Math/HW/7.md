...
Let $s_0,s_1,s_2,...$ be defined by the formula $s_n= \frac{(-1)^n}{}$ for every integer n $ 0. Show that this sequence satis-
fies the following recurrence relation for every integer
k $ 1:
