...
Let the domain of $x$ be the set $D$ of objects discussed in mathematics courses, and let $Real(x)$ be “$x$ is a real number,” $Pos(x)$ be “$x$ is a positive real number,” Neg(x) be “x is a negative real number,”
