...
$cy_h(t)+y_p(t)$ is also a solution to the non-homogeneous 

## Constant-coefficient

A linear differential equation is considered constant-coeffecient if $a(t)=\lambda$ where $\lambda$ is a constant.
