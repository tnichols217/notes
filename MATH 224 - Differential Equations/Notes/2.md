...
Three dimensional systems have much less restriction than those of two or one dimentional, as the sample space is significantly less likely to be partitioned by simple clases.