...
flexGrow=0.4
===
![[Pasted image 20220523120456.png]]
...
So as you can see here, Linus, the inventor of Linux is flipping off Nvidia because of their proprietary and broken drivers. They also make it incredibly difficult to fix their broken drivers and also lock down their hardware to certain features only, when the hardware physically can handle more.
%%
...
flexGrow=0.2
===
![[Pasted image 20220523122810.png]]
```
````
...
So, why mac just isnt that good ahem david. For one, theres not a solid app store, and like if there was one, i betchu apple wouldnt let you install anything but whats on the store, so itll be even worse plEASE as well as, it doesnt allow you to customize much, takes up a lot of storage, is expensive, only runs on macs- like what if i want to run it on my own computer? Well i cant ohwell. And you simply do not get the freedom to do what you want with your computer as well as stopping me from just removing things I dont like or dont need.
%%
