...
$M(x)=\frac{e^{t\mu}}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{(2tu\sigma^2-u^2)/(2\sigma^2)}dx$
$M(x)=\frac{e^{t\mu}}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{(-(u-t\sigma^2)^2+t^2\sigma^4)/(2\sigma^2)}dx$
$M(x)=\frac{e^{t\mu}e^{\sigma^2t^2/2}}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{-(u-t\sigma^2)^2/(2\sigma^2)}dx$
$M(x)=\frac{e^{t\mu}e^{\sigma^2t^2/2}}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{-(\frac{u-t\sigma^2}{\sqrt2\sigma})^2}dx$
Let $v=\frac{u-t\sigma^2}{\sqrt2\sigma}$ and $dv=$
