...
$\mu_3=E((X-\mu)^2)$
$\mu_3=\int\limits_0^\infty(x-1)^2e^{-x}dx$
$\mu_3=\int\limits_0^\infty(x^2-2x+1)e^{-x}$
$\mu_3=-(x^2+2x+2-2x-2+1)e^{-x}\bigg\vert_0^\infty$
$\mu_3=-(x^2+1)e^{-x}\bigg\vert_0^\infty$
$\mu_3=1$
...
$EX=\int\limits_{-\infty}^\infty xe^{-x}dx$
