...
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{tx}e^{-(x-\mu)^2/(2\sigma^2)}dx$
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{tx-(x-\mu)^2/(2\sigma^2)}dx$
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{(-x^2+2\mu x+2t\sigma^2x-\mu^2)/(2\sigma^2)}dx$
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{(-(x-(\mu+t\sigma))^2+\mu^2+t^2\sigma^2+2\mu t\sigma)-\mu^2/(2\sigma^2)}dx$
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{(-(x-(\mu+t\sigma))^2+t^2\sigma^2+2\mu t\sigma)/(2\sigma^2)}dx$
$M(x)=\frac{e^{t^2\sigma^2+2ut\sigma}}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{(-(x-(\mu+t\sigma))^2+t^2\sigma^2+2\mu t\sigma)/(2\sigma^2)}dx$

$\frac{d}{dx}tx-(x-\mu)^2/(2\sigma^2)$
$=t-2(x-\mu)/(2\sigma^2)$

$M(x)=\frac{1}{\sqrt{2\pi}\sigma}(x(t-2(x-\mu)/(2\sigma^2))e^{tx-(x-\mu)^2/(2\sigma^2)}-e^{tx-(x-\mu)^2/(2\sigma^2)})\bigg\vert_0$
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}(-x(x-\mu)/\sigma^2)e^{-(x-\mu)^2/(2\sigma^2)}-e^{-(x-\mu)^2/(2\sigma^2)})$
$M(x)=\frac{1}{\sqrt{2\pi}\sigma}(-1/(2\sigma^2))\bigg\vert_0$
