...
$M(x)=\int\limits_{-\infty}^\infty e^{t(x+\mu)}\frac{e^{-u^2/(2\sigma^2)}}{\sqrt{2\pi}\sigma}dx$


$M(x)=\frac{e^{t\mu}}{\sqrt{2\pi}\sigma}\int\limits_{-\infty}^\infty e^{tu}e^{-u^2/(2\sigma^2)}dx$
