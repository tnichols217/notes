...
$EX^2=\frac{d}{dx}\frac{(pe^t-p^2e^t)(1-e^t(1-p))^2+2(pe^t-p^2e^t)(1-e^t(1-p))(e^t(1-p))}{(1-e^t(1-p))^4}\bigg\vert_0$
$EX^2=\frac{d}{dx}\frac{(p-p^2)(p)^2+2(p-p^2)(p)(1-p)}{p^4}\bigg\vert_0$
$EX^2=\frac{d}{dx}\frac{(p-p^2)+2(1-p)(1-p)}{p^2}\bigg\vert_0$
$EX^2=\frac{d}{dx}\frac{p-p^2+2-4p+2p^2}{p^2}\bigg\vert_0$
$EX^2=\frac{d}{dx}\frac{p^2-3p+2}{p^2}\bigg\vert_0$
$EX^2=\frac{d}{dx}\frac{(p-2)(p-1)}{p^2}\bigg\vert_0$
