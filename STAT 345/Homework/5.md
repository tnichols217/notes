...
$=(-2tx(x-\mu)-t(x-\mu)^2)/(2\sigma^2)$
$=(-2tx^2+2tx\mu-tx^2+t2x\mu-t\mu^2)/(2\sigma^2)$
$=(-2tx^2+4tx\mu-tx^2-t\mu^2)/(2\sigma^2)$
$=t(-3x^2+4x\mu-\mu^2)/(2\sigma^2)$
$=-t(3x-\mu)(x-\mu)/(2\sigma^2)$

$M(x)=\frac{1}{\sqrt{2\pi}\sigma}(-x(2tx(x-\mu)+t(x-\mu)^2)e^{-tx(x-\mu)^2/(2\sigma^2)}-e^{-tx(x-\mu)^2/(2\sigma^2)}/(2\sigma^2))\bigg\vert_0$
