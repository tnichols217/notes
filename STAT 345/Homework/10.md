...
$=\frac{1}{a^2\sigma_X^2\sigma_Y^2}(\sigma_Y^2(u^2-2buv-2au\mu_X+b^2v^2+bva\mu_X+a^2\mu_X^2)-2\rho a\sigma_X\sigma_Y \left(u-(bv+a\mu_X)\right)\left( \frac{y-\mu_Y}{\sigma_Y} \right) )+ \left( \frac{y-\mu_Y}{\sigma_Y} \right)^2$
