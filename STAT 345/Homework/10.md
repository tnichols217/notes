...
$f(x,y)=\frac{1}{2\pi\sigma_X\sigma_Y\sqrt{1-\rho^2}}\exp\left( -\frac{1}{2(1-\rho^2)}\left( z_x^2 -2\rho \left(z_X\right)\left(z_Y\right) + \left( \frac{y-\mu_Y}{\sigma_Y} \right)^2 \right) \right)$
