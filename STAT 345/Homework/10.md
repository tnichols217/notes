...
$=\frac{1}{a^2\sigma_X^2\sigma_Y^2}(\sigma_Y^2(u^2-2buv-2au\mu_X+b^2v^2+bva\mu_X+a^2\mu_X^2)-2\rho a\sigma_X\sigma_Y \left(uv-u\mu_Y-bv^2-av\mu_X+\mu_Ybv+\mu_Ya\mu_X\right)+a^2\sigma_X^2(v^2-2v\mu_Y+\mu_Y^2)$

$=(\sigma_Y^2b^2+2\rho ab\sigma_X\sigma_Y+a^2\sigma_X^2)v^2+(-2\sigma_Y^2bu+\sigma_Y^2ab\mu_X-2\rho a\sigma_X\sigma_Yu+2\rho a\sigma_X\sigma_Ya\mu_X-2\rho a\sigma_X\sigma_Y\mu_Yb-2a^2\sigma_X^2\mu_Y)v$
$+\sigma_Y^2(u^2-2au\mu_X+a^2\mu_X^2)-2\rho a\sigma_X\sigma_Y(-u\mu_Y)$
# 5.3
