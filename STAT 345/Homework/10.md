...
$f(x,y)=\frac{1}{2\pi\sigma_X\sigma_Y\sqrt{1-\rho^2}}\exp\left( -\frac{z_X^2 -2\rho z_Xz_Y + z_Y^2}{2(1-\rho^2)}\right)$
$f_{UV}(u,v)=\frac{1}{2a\pi\sigma_X\sigma_Y\sqrt{1-\rho^2}}\exp\left( -\frac{(\frac{u-(bv+a\mu_X)}{a\sigma_X})^2 -2\rho (\frac{u-(bv+a\mu_X)}{a\sigma_X})z_Y + z_Y^2}{2(1-\rho^2)}\right)$
