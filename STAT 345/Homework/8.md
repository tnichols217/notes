...
$F_Z(z)=\begin{cases}1&z<1\\((\sqrt{9/Z}-1)^2+2(\sqrt{9/Z}-1))/8&1\le z<9\\0&9\le z\end{cases}$
$=\begin{cases}1&z<1\\(9/Z-2\sqrt{9/Z}+1+2\sqrt{9/Z}-2)/8&1\le z<9\\1&9\le z\end{cases}$
$=\begin{cases}0&z<1\\(9/Z-1)/8&1\le z<9\\1&9\le z\end{cases}$
