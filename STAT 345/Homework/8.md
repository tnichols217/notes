...
$=\begin{cases}0&x<0\cup y<0\\\frac{1}{8}x^2y+\frac{1}{4}xy^2&0\le x< 2\cap0\le y<1\\(\frac{1}{2}y+\frac{1}{2}y^2&2\le x\cap 0\le y<1\\(x^2/2+x)/4&0\le x<2\cap 1\le y\\1&2\le x\cap1\le y\end{cases}$
