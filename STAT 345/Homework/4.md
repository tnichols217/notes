...
$=\begin{cases}\int\limits_0^1 3(\sqrt{1-y}-2(1-y)+(1-y)^{-1/2})/16dy&\text{for x>0}\\\int\limits_1^0 3(\sqrt{1-y}+2(1-y)+(1-y)^{-1/2})/16dy&\text{for x<0}\end{cases}$
$=\begin{cases}\int\limits_0^1((-\sqrt{1-y})+1)^3/8dy&\text{for x>0}\\\int\limits_1^0((+\sqrt{1-y})+1)^3/8dy&\text{for x<0}\end{cases}$
