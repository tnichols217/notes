...
$g^{-1}(x)=\begin{cases}  3(-\sqrt{1-y}+1)^2|(1-y)^{-1/2}/2|/8&x\le0;1>y\ge0\\3(1-y+1)^2/8&x>0;1>y>0\end{cases}$
$g^{-1}(x)=\begin{cases}3(-\sqrt{1-y}+1)^2(1-y)^{-1/2}/16&x\le0;1>y\ge0\\3(2-y)^2/8&x>0;1>y>0\end{cases}$
$\square$

$\int f_Y(y)dy=\begin{cases}\int3(-\sqrt{1-y}+1)^2(1-y)^{-1/2}/16dy&x\le0;1>y\ge0\\\int3(2-y)^2/8dy&x>0;1>y>0\end{cases}$
$\int f_Y(y)dy=\begin{cases}(-\sqrt{1-y}+1)^3/8&x\le0;1>y\ge0\\(x+1)^3/8&x>0;1>y>0\end{cases}$
