...
$E(X)=\frac{1}{2\sigma}(\int\limits_{-\infty}^0 \sigma (\sigma u+\mu)e^udu+\int\limits_{-\infty}^0\sigma(\sigma v-\mu)e^vdx)$
$E(X)=\frac{1}{2}(\sigma\int\limits_{-\infty}^0 ue^udu+\mu\int\limits_{-\infty}^0e^udu+\sigma\int\limits_{0}^\infty ve^vdx-\mu\int\limits_{0}^\infty e^vdx)$
