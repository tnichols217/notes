...
$E(X)=\int\limits_{-\infty}^\infty xf(x)dx$
$E(X)=\frac{1}{2\sigma}\int\limits_{-\infty}^\infty x\frac{e^{-|x-\mu|/\sigma}}{2\sigma}dx$
$E(X)=\int\limits_{-\infty}^\mu x\frac{e^{-|x-\mu|/\sigma}}{2\sigma}dx+\int\limits_{\mu}^\infty x\frac{e^{-|x-\mu|/\sigma}}{2\sigma}dx$
$E(X)=\int\limits_{-\infty}^\mu x\frac{e^{(x-\mu)/\sigma}}{2\sigma}dx+\int\limits_{\mu}^\infty x\frac{e^{(\mu-x)/\sigma}}{2\sigma}dx$
