...
$f_Y(y)=\frac{(1/y)^{\alpha-1}e^{-(1/y)/\beta}}{2y^2\Gamma(\alpha)\beta^\alpha}$
$f_Y(y)=\frac{y^{-\alpha+1}e^{-(1/y)/\beta}}{2y^2\Gamma(\alpha)\beta^\alpha}$
$f_Y(y)=\frac{y^{-\alpha-1}e^{-(1/y)/\beta}}{2\Gamma(\alpha)\beta^\alpha}$
