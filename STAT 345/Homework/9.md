...
$f_{U}(u)=M\int\limits_u^{1/u}(\frac{\sqrt U}{U+Z-UZ}\frac{Z-UZ}{U+Z-UZ})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}((1-U)(1-Z))^{\gamma-1}~dv$
$f_{U}(u)=M\int\limits_u^{1/u}(\frac{\sqrt UZ(1-U)}{(U+Z-UZ)^2})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}((1-U)(1-Z))^{\gamma-1}~dv$
