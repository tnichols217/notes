...
$\bar p=\frac{\beta}{1+\beta}$

$f_Y(y)=\begin{pmatrix}y+\alpha-1\\y\end{pmatrix}(\bar p)^{y}(1-\bar p)^{\alpha}$

$Y\sim\text{NegBinom}(\alpha,\frac{\beta}{1+\beta})$

### $EX$

$\mu=\frac{\alpha\left( \frac{1}{1+\beta} \right)}{\frac{\beta}{1+\beta}}$
