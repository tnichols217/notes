...
$f_{U}(u)=M\int\limits_u^{1/u}(\sqrt \frac{U}{(-(1-U)(1-Z)+1)^2}(1-\sqrt{U\frac{U}{(-(1-U)(1-Z)+1)^2}}))^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}(1-\sqrt{\frac{U}{\frac{U}{(-(1-U)(1-Z)+1)^2}}})^{\gamma-1}~dz$
$f_{U}(u)=M\int\limits_u^{1/u}(\frac{\sqrt U}{-(1-U)(1-Z)+1}\frac{Z-UZ}{-(1-U)(1-Z)+1})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}((1-U)(1-Z))^{\gamma-1}~dv$
$f_{U}(u)=M\int\limits_u^{1/u}(\frac{\sqrt UZ(1-U)}{-(1-U)(1-Z)+1})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}((1-U)(1-Z))^{\gamma-1}~dv$
$f_{U}(u)=M\int\limits_u^{1/u}(\frac{\sqrt UZ}{Z})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}((1-U)(1-Z))^{\gamma-1}~dv$

$f_{U}(u)=2\sqrt U(1-U)M\int\limits_0^{1}(\sqrt{\frac{U}{((1-U)Z+U)^2}}-\frac{U}{((1-U)Z+U)^2}\sqrt{U})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}(1-\sqrt{\frac{U}{\frac{U}{((1-U)Z+U)^2}}})^{\gamma-1}~dz$
$f_{U}(u)=2\sqrt U(1-U)M\int\limits_0^{1}(\frac{\sqrt U}{(1-U)Z+U}-\frac{U}{((1-U)Z+U)^2}\sqrt{U})^{\beta-1}{\frac{\sqrt U}{(1-U)Z+U}}((1-U)(1-Z))^{\gamma-1}~dz$
