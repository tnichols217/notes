...
$f_{U}(u)=2\sqrt U(1-U)M\int\limits_0^{1}(\sqrt{\frac{\sqrt U}{(1-U)Z+U}}-\frac{U}{((1-U)Z+U)^2}\sqrt{U})^{\beta-1}\sqrt{\frac{U}{((1-U)Z+U)^2}}(1-\sqrt{\frac{U}{\frac{U}{((1-U)Z+U)^2}}})^{\gamma-1}~dz$
