...
$f_{U}(u)=\frac{\Gamma(\alpha+\beta+\gamma)}{\Gamma(\alpha)\Gamma(\beta+\gamma)}U^{\alpha}(1-U)^{\beta+\gamma-1}\int\limits_0^{1} \frac{\Gamma(\beta+\gamma)}{\Gamma(\bet)}\left( Z\right)^{\beta-1}\left( 1-Z \right)^{\gamma-1}~dz$
