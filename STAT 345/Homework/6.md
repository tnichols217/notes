...
$=1-P(Y\le n-r)$
$=P(Y>n-r)$
Which means the probability of taking more than $n$ trials to get $r$ successes with probability $p$, which also means getting less than or equal to $r-1$ successes
