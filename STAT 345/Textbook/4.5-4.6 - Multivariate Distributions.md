...
$J_{\mathbf X\mathbf Yi}=\begin{vmatrix}\frac{\partial h_{1i}(\mathbf Y))}{\partial y_1}&...&\frac{\partial h_{1i}(\mathbf Y))}{\partial y_n}\\\frac{\partial h_{1i}(\mathbf Y))}{\partial y_1}&...&\frac{\partial h_{1i}(\mathbf Y))}{\partial y_n}\end{vmatrix}$
