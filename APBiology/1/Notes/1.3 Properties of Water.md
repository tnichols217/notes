...
> ````col
> ```col-md
> - Calculate the concentration of $[H^+]$ by using the Water Dissociation Constant
> ```
> ```col-md
> 1. $[OH^-] = 10^{-3}$
> 2. $[H^+][OH^-] = 10^{-14}$
...
> ````col
> ```col-md
> - Calculate the pH using the definition of pH
> ```
> ```col-md
> 1. $[H^+] = 10^{-11}$
> 2. $pH = -\log{[H^+]}$
...
> ````
>> [!conclusion]
>> We can conclude that the pH of this solution is 11, which is highly Basic.