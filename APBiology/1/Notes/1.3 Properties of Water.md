...
#### Calculating pH
> [!example]
>> 1. Given that the concentration of $[OH^-] = 10^{-3}$ find the pH.
...
> ***
>> [!TODO]
>> 2. Given that the concentration of $[H^+]$ is 10000 times more than the concentration of $[OH^-]$, what is the pH
>> Assume the solution is at $25^oC$
>
> ````col
> ```col-md
