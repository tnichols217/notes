...
$\implies \ln(\frac{\sigma_1}{\sigma_2})=(\frac{1}{2\sigma_2^2}-\frac{1}{2\sigma_1^2})\theta^2-\frac{1}{2\sigma_2^2}\mu_2\theta+\frac{1}{2\sigma_2^2}\mu_2^2)-\frac{1}{2\sigma_1^2}(\theta^2+\frac{1}{2\sigma_1^2}\mu_1\theta-\frac{1}{2\sigma_1^2}\mu_1^2)$
