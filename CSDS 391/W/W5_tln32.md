...
$=\sum\limits_{n=0}^N\frac{\partial}{\partial\sigma}\frac{1}{2}2\pi\sigma^2\frac{-2}{2\pi\sigma^3}+\sum\limits_{n=0}^N\frac{\partial}{\partial\sigma}\frac{1}{2\sigma^2}(\vec x_n-\mu)^2$
