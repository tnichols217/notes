...
I initially chose a larger epsilon value (0.1) but i noticed over a short training interval that the center model was "bouncing" across the solution indefinitely, so then lowered it to 
