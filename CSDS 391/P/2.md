...
$\frac{\partial \mathbf w^T@\vec i}{\partial \mathbf w}=[\frac{\partial \vec w_1^T@\vec i}{\partial \vec w_1},...,\frac{\partial \vec w_n^T@\vec i}{\partial \vec w_n},...,\frac{\partial \vec w_N^T@\vec i}{\partial \vec w_N}]$

$\frac{\partial \vec w_n^T@\vec i}{\partial \vec w_n}$
