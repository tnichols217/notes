...
| Formula                                                             | Proof                       |
| ------------------------------------------------------------------- | --------------------------- |
| $\vec{c}\perp\vec{a},\vec{c}\perp\vec{b}$                           | Definition of Cross Product |
| $\vec{c}\cdot\vec{a}=0,\vec{c}\cdot\vec{b}=0$                       | Property of Dot products    |
| $c_1a_1+c_2a_2+c_3a_3=0,c_1b_1+c_2b_2+c_3b_3$                       | Expansion of dot product    |
| $c_1a_1b_3+c_2a_2b_3=0+a_3b_3c_3=0,c_1b_1a_3+c_2b_2a_3+a_3b_3c_3=0$ | Multiply                    |
| $c_1(a_1b_3-b_1a_3)+c_2(a_2b_3-b_)                                                                    |                             |
