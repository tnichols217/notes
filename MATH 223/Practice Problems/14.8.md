...
$=\begin{cases}x_j=\frac {Ne^{\rho E_j}}{\sum\limits_{j=1}^ne^{\rho E_j}}\qquad\forall x_j\in\{x_1,...,x_n\}\\\sum\limits_{j=1}^nE_je^{\rho E_j}=\frac {E\sum\limits_{j=1}^nF_j}{N}\end{cases}$
