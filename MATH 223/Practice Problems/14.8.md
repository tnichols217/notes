...
$=\begin{cases}x_j=\frac {Ne^{\mu E_j}}{\sum\limits_{j=1}^ne^{\mu E_j}}\qquad\forall x_j\in\{x_1,...,x_n\}\\\sum\limits_{j=1}^nE_je^{\mu E_j}=\frac {E}{N}\sum\limits_{j=1}^ne^{\mu E_j}\end{cases}$

The first line proves the statement

Let $F_j=e^{\mu E_j}\qquad\forall E_j\in\{E_1,...,E_n\}$

$=\begin{cases}x_j=\frac {Ne^{\mu E_j}}{\sum\limits_{j=1}^ne^{\mu E_j}}\qquad\forall x_j\in\{x_1,...,x_n\}\\\sum\limits_{j=1}^nE_jF_j=\frac {E}{N}\sum\limits_{j=1}^nF_j\end{cases}$
