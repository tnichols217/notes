...
$\nabla f=\langle2\pi h,2\pi r\rangle=\lambda\nabla g=\lambda\langle2\pi rh,\pi r^2\rangle$

$=\begin{cases}2\pi h=\lambda2\pi rh\\2\pi r=\lambda\pi r^2\\\pi r^2h=54\pi\end{cases}$
$=\begin{cases}1=\lambda r\\2=\lambda r\\\pi r^2h=54\pi\end{cases}$
