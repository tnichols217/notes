...
$=\begin{cases}x_j=\frac {NF_j}{\sum\limits_{j=1}^nF_j}\qquad\forall x_j\in\{x_1,...,x_n\}\\{\sum\limits_{j=1}^nE_jF_j}=\frac {E}{N}\sum\limits_{j=1}^nF_j\end{cases}$
$=\begin{cases}x_j=\frac {NF_j}{\sum\limits_{j=1}^nF_j}\qquad\forall x_j\in\{x_1,...,x_n\}\\\prod\limits_{j=1}^ne^{E_jF_j}=e^{\frac{E}{N}}\prod\limits_{j=1}^ne^{F_j}\end{cases}$
$=\begin{cases}x_j=\frac {NF_j}{\sum\limits_{j=1}^nF_j}\qquad\forall x_j\in\{x_1,...,x_n\}\\\prod\limits_{j=1}^ne^{(E_j-1)F_j}=e^{\frac{E}{N}}\end{cases}$
