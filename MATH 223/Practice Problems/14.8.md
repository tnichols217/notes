...
$g(x_1,...,x_n)=x_1+...+x_n-B=0\quad B>0$
$h_j(x_1,...,x_n)=x_j\ge0\quad x_j\in \{x_1,...,x_n\}$

$\nabla f=\langle\frac{1}{x_1}\prod\limits_{j=1}^nx_j,...,\frac{1}{x_n}\prod\limits_{j=1}^nx_j\rangle$
$\nabla g=\langle1,...,1\rangle$

$\begin{cases}\langle1/x_1,...,1/x_n\rangle\prod\limits_{j=1}^nx_j=\lambda\langle1,...,1\rangle\\x_1+...+x_n=B\qquad B>0\end{cases}$
$\begin{cases}\langle1/x_1,...,1/x_n\rangle=\frac{\lambda}{\prod\limits_{j=1}^nx_j}\langle1,...,1\rangle\\x_1+...+x_n=B\qquad B>0\end{cases}$
$\begin{cases}\langle x_1,...,x_n\rangle=\frac{\prod\limits_{j=1}^nx_j}{\lambda}\langle1,...,1\rangle\\x_1+...+x_n=B\qquad B>0\end{cases}$
$\begin{cases}x_i=\frac{\prod\limits_{j=1}^nx_j}{\lambda}\qquad x_i\in\{x_1,...,x_n\}\\x_1+...+x_n=B\qquad B>0\end{cases}$
