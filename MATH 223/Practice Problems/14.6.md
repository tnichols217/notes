...
$y=s-t$
$f(x,y)$
$\vec r(s,t)=\langle s+t,s-t\rangle$



$\frac{\partial f}{\partial x}=\frac{\partial f}{\partial s}\frac{\partial s}{\partial x}+\frac{\partial f}{\partial t}\frac{\partial s}{\partial x}$
