...
$\int\limits_CF~ds=\int\limits_0^1\vec F(\vec r(t))\cdot\vec r'(t)~dt$
$=\int\limits_0^1\langle\sin^2 t,-\sin t\cos t\rangle\cdot\langle-\cos t,-\sin t\rangle~dt$
$=\int\limits_0^1-\sin^2 t\cos t+\sin^2t\cos t~dt$
$=\int\limits_0^10~dt$
$=0$

# 23

$\vec F(x,y)=\langle3zy\rangle$
