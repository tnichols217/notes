...
$=\int\limits_0^{2\pi}\int\limits_0^1-r^2\cos^2\theta~drd\theta$
$=\int\limits_0^{2\pi}-\frac{1}{2}\cos^2\theta~d\theta$
$=\int\limits_0^{2\pi}-\frac{1}{2}(\frac{1}{2}+\frac{\cos(2\theta)}{2})~d\theta$
$=\bigg|_0^{2\pi}-\frac{1}{2}(\frac{1}{2}\theta+\frac{\sin(2\theta)}{2})~d\theta$
