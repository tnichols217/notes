...
$=f(B)-f(A)+\iint\limits_D\vec G(\vec C(t))\cdot\vec C'(t)~dt-\oint\limits_{BO}\langle0,0\rangle\cdot\langle 0,1\rangle dt-\oint\limits_{OA}\langle0,t\rangle\cdot\langle 1,0\rangle dt$
$=f(B)-f(A)+\iint\limits_D\langle0,\cos t\rangle\cdot\langle-\sin t,\cos t\rangle~dt$
