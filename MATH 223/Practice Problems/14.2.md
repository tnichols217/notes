...
$\lim\limits_{y\rightarrow0}\frac{2y}{y(y^2+1)^{-1/2}}$
$=\lim\limits_{y\rightarrow0}\frac{2}{(y^2+1)^{-1/2}}$
$=2$

And the same is true for $x$, meaning the original limit is also $2$
