...
$=\langle\frac{\partial}{\partial x}\vec F_x+\frac{\partial}{\partial x}\vec G_x,\frac{\partial}{\partial y}(\vec F_y+\vec G_y),\frac{\partial}{\partial z}(\vec F_z+\vec G_z)\rangle$
