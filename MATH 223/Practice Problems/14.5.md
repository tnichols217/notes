...
$\begin{cases}f_xx+z+4x+3y^2z^2f_x=0\\f_yx+2z^3y+3y^2z^2f_y=0\end{cases}$

$\begin{cases}2f_{xP}+1+8+3f_{xP}=0\\2f_{yP}+2+3f_{yP}=0\end{cases}$
$\begin{cases}f_{xP}=\frac{-9}{5}\\f_{yP}=\frac{-2}{5}\end{cases}$
$\nabla f(P)=\langle-\frac{9}{5},-\frac{2}{5}\rangle$

$L_P(x,y)=1-\frac{9}{5}(x-2)-\frac{2}{5}(y-1)$
$L_P(x,y)=-\frac{9}{5}x-\frac{2}{5}y+\frac{17}{5}$
