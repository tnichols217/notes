...
$=\begin{cases}x=\mp2\sqrt{1-\frac{x^2}{4}-\frac{(\mp4.5\sqrt{1-\frac{x^2}{4}-\frac{y^2}{9}})^2}{9}}\\y=\mp4.5\sqrt{1-\frac{(\mp2\sqrt{1-\frac{x^2}{4}-\frac{y^2}{9}})^2}{4}-\frac{y^2}{9}}\end{cases}$
$=\begin{cases}x=\mp2\sqrt{1-\frac{x^2}{4}-\frac{9}{4}\frac{1-\frac{x^2}{4}}-\frac{y^2}{9}}\\y=\mp4.5\sqrt{1-\frac{(\mp2\sqrt{1-\frac{x^2}{4}-\frac{y^2}{9}})^2}{4}-\frac{y^2}{9}}\end{cases}$
