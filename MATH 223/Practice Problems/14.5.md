...
$=\begin{cases}x^2=2-\frac{2y^2}{9}\\y^2=\frac{81}{4}-\frac{81}{8}+\frac{18y^2}{16}-\frac{9y^2}{4})\end{cases}$
$=\begin{cases}x^2=2-\frac{2y^2}{9}\\y^2=\frac{81}{8}+\frac{18y^2}{16}-\frac{9y^2}{4})\end{cases}$
