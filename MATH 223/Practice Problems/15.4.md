...
$=\int\limits_0^{2\pi/3}\int\limits_0^2r^2~drd\theta+\int\limits_0^1\int\limits_0^xx^2+y^2~dydx$
$=\int\limits_0^{2\pi/3}8/3~d\theta+\int\limits_0^1\int\limits_0^xx^3+x^3/3~dx$
