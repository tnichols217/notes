...
$=2\int\limits_0^{\pi/4}\int\limits_{\cos\theta}^\sqrt2-r^{-2}/2~drd\theta$
$=2\int\limits_0^{\pi/4}\int\limits_{\cos\theta}^\sqrt2-r^{-2}/2~drd\theta$
$=2\int\limits_0^{\pi/4}\ln\sqrt2-\ln\cos\theta~d\theta$
$=\int\limits_0^{\pi/4}\ln2-2\ln\cos\theta~d\theta$
