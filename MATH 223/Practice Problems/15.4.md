...
$=\int\limits_0^{2\pi/3}\int\limits_0^2r^3~drd\theta+\int\limits_0^1\int\limits_0^{\arctan\pi/3}x^2+y^2~dydx$
$=\int\limits_0^{2\pi/3}4~d\theta+\int\limits_0^1x^3+x^3/3~dx$
$=8\pi/3+1/4+1/12$
$=8\pi/3+1/3$
