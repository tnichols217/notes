...
Hint: Use your result of part (a)
 ...
 > $=\pi(2rdr+dr^2)$
 > 
> $\phi(z)=\frac{1}{2\epsilon_0}\frac{rdr}{\sqrt{r^{2}+z^{2}}}$
> $\square$
...
> [!answer]
> $\phi(z)=\int\limits_{0}^{R}\frac{1}{2\epsilon_0}\frac{rdr}{\sqrt{r^{2}+z^{2}}}$
> $\phi(z)=\frac{1}{2\epsilon_0}\sqrt{r^{2}+z^{2}}\bigg|_{0}^{R}$
> $\phi(z)=\frac{1}{2\epsilon_0}\left(\sqrt{R^{2}+z^{2}}-z\right)$
> $\square$
