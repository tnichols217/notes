...
> [!para]
> My art teacher said, anyone can learn to be a good painter but not every good painter is an artist. I chose Columbia not because I want to only be the best coder, engineer or, 3D renderer, but because I want to be a successful innovator and entrepreneur. Columbia understands and acknowledges the importance of innovation and provides invaluable resources like expert mentorship, critical infrastructure, unique R&D resources, and state-of-the-art facilities. ~~Columbia already has a rich innovation ecosystem which I wish to be a part of if given the opportunity.~~ This environment will assist and propel me towards fulfilling my dream in realizing my innovations. I am equally excited to see that Columbia places an importance in sustainability and climate. Having spent much time in the jungles and with the indigenous people, I understand how alarming the issues of sustainability and climate is. I have a penchant for computer science (best student award) and have been tinkering with engineering (AP Physics-5) since young. I have an eye for design and completed AP Art 3D Design (results in July 2022). I am very proficient using Blender for 3D rendering (3 unsolicited internship offers). I have served in rainforests and mountainous jungles and therefore understands the needs of the environment. But most of all, I have the passion to invent, innovate, create for the environment. ~~I am ripe for the picking~~. Allow me to be the “artist” and not just a good painter.
