...
> [!para]
> As I regularly volunteer in my church and have earned the role of church tech coordinator, I made the recommendation that we upgrade our sound mixing board, as the current one used had broken channels and broken faders amongst other things. A few weeks later we purchased a new board on my recommendation, but what I neglected to see was that the speakers the church owned were unpowered, meaning that the input would need to have been through a preamp. Unbeknownst to me, the old board has a built in preamp - something not really common anymore - and the new one did not have one at all. On the first day of using the new board in the church service, we noticed we could not go to nearly as high a volume as we normally could and his voice was peaking in certain frequencies, leading to an unrecognizable sound signature. I quickly spotted the issue but did not know what we could do to fix it, so my innovative solution was to use the old board as a preamp for the new board. This bypasses any problems we have with the old board since we were no longer using that board to mix sound, and simply as a preamp. These quick, on the spot ideas are some simple examples of innovation in my life.
...
> [!para]
> On 30 Oct '22, racecar driver Ross Chastain pulled off a successful wall ride in a NASCAR Cup race. I wish I could have seen that in person as it is quite a crazy and abnormal thing to do. It will definitely go down in NASCAR history.
...
> [!para]
> I hold a tech internship position in my school as an extracurricular. This time is spent on developing school projects like the intranet, search image student application, firewall, and other internally hosted sites. I also service laptops, manage server instances, install hardware in classrooms, and provide general tech support.
...
> [!para]
> I can easily get very hype. Turn on some music and I will bop with you for hours or by myself even. I am fairly to mostly sociable. If you are interested, I could talk for hours on why the letter 'a' should be removed from the keyboard, or, why it’s better to take a test while you're sweating buckets. On the complete flip side, if you prefer to have peace and quiet, I could study for hours on end without saying a single word (although you would probably hear me happily tapping away on my keyboard). I love to try crazy things; rock climbing for me was crazy at first, but it has now become my norm. I will try anything maybe twice before realizing that it was stupid and that I shouldn't have done that. I am very driven. Once I start on something I will not let off until it is completely satisfyingly finished. I love cardio. I know how a lot of people hate cardio lately, but I find that the perseverance and determination needed to complete long sessions of cardio are really motivating for me. Don't worry, I still love normal workouts, although I lean more on the calisthenics side. Lastly, I love to eat good food, coming from a food-centric culture, I love to eat rice dishes in particular. I also know how to cook and bake basic things like omelets, chicken curry, pizza, bagels, and of course rice.
